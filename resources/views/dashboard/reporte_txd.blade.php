...
var FILTER_OPTIONS = {};
var LS_FILTERS_KEY = 'pivot_txd_filters_v1';
...
var DET_COLS = [
  ...
  { field:'vta_si26',   headerName:'Vta SI 26',     width:115, valueFormatter:mFmt },
  { field:'vta_si25',   headerName:'Vta SI 25',     width:115, valueFormatter:mFmt },
];
...
async function loadDetalle(){
  try {
    var r    = await fetch('/dashboard/reporte-txd/detalle?'+filterParams());
...
async function loadPivotData(){
  ...
  detLoaded = false;
  try {
    var r    = await fetch('/dashboard/reporte-txd/pivot?'+new URLSearchParams({ini:activeIni,fin:activeFin}));
...
/* ══════════════════════════════════════════════════════════
   PANEL COLAPSABLE
   ══════════════════════════════════════════════════════════ */
var LS_PANEL_KEY = 'pivot_txd_panel_collapsed';
...
/* ══════════════════════════════════════════════════════════
   AUTO-ACTUALIZACIÓN
   ══════════════════════════════════════════════════════════ */
var LS_LIVE_KEY = 'pivot_txd_live_ms';
var liveTimer = null;
