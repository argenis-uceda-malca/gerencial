...
@section('contenido')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card-body">
                        <div class="row gy-3 gx-3 align-items-end flex-wrap">
                            ...
                            <div class="col-12 col-lg-auto">
                                {{-- <label for="selectSucursales" class="form-label">Seleccione las Sucursales</label> --}}
                                <select multiple class="form-select" id="selectSucursales" name="sucursales[]">
                                    @foreach ($sucursales as $item)
                                        <option value="{{ $item->idsucursal }}">{{ $item->abreviado }}</option>
                                    @endforeach
                                </select>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="card mb-3">
                    <div class="card-header" style="color: #696cff; background-color: rgba(105, 108, 255, 0.16) !important; font-weight: 600;">
        ...
        <script type="text/babel">
                ...
                columnDefs: [
                      {
                        ...
                        floatingFilter: true,
                        cellRenderer: params => {
                            return `<span style="color:#727278;">🏢 ${params.value}</span>`;
                        }
                    },
                    {
                        headerName: '⏳ Recencia',
                    ...
                    },
                    {
                        ...
                        cellRenderer: params => {
                            if (params.value == null || params.value === '') return '';
                            return `<span style="color:#00503c;">S/ ${params.value}</span>`;
                        }
                    },
                    {
                        headerName: '🎟️ Cant. Tickets',
                        field: 'CANT_TICKETS',
                        width: 160,
                        filter: true,
                        floatingFilter: true,
                    ...
                    },
                    {
                        ...
                        floatingFilter: true,
                        cellRenderer: params => {
                            if (!params.value || params.value === 'undefined') return ''; // solución
                            return `<span style="color: #021742">👤 ${params.value}</span>`;
                        }
                    },
                    {
                        headerName: '☎️ Teléfono',
                        field: 'telefono',
                        width: 150,
                        filter: true,
                        floatingFilter: true
                    ...
                    },
                    {
                        ...
                        cellRenderer: params => {
                            if (!params.value || params.value === 'undefined') return ''; // solución
                            return `<a href="mailto:${params.value}" style="color: #007bff; text-decoration: none;">📧 ${params.value}</a>`;
                        }
                    }
            ...
            $('#myform').on('submit', function(event) {
                ...
                $.ajax({
                    url: '/submit_rfm', // Asegúrate que esta ruta exista
                    method: 'POST',
                    data: formData,
